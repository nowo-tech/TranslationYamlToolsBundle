...
final class GoogleTranslateMachineTranslatorTest extends TestCase
{
    public function testTranslateSuccess(): void
    {
        ...
        $translator = new GoogleTranslateMachineTranslator($client, 'api-key');
    ...
    {
        $client     = new MockHttpClient();
        $translator = new GoogleTranslateMachineTranslator($client, '');
    ...
    public function testThrowsOnHttpError(): void
    {
        ...
        $translator = new GoogleTranslateMachineTranslator($client, 'k');
        $this->expectException(RuntimeException::class);
