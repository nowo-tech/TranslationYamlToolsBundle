...
final class DeeplMachineTranslatorTest extends TestCase
{
    public function testTranslateSuccess(): void
    {
        ...
        $translator = new DeeplMachineTranslator($client, 'auth', 'https://api.example.com/v2/translate');
    ...
    {
        $client     = new MockHttpClient();
        $translator = new DeeplMachineTranslator($client, '', 'https://api.example.com/v2/translate');
    ...
    public function testThrowsOnHttpError(): void
    {
        ...
        $translator = new DeeplMachineTranslator($client, 'k', 'https://api.example.com/v2/translate');
        $this->expectException(RuntimeException::class);
