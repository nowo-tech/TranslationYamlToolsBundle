...
**Tag message:** keep the first line short (e.g. `0.3.0: missing translation log, async flush`); GitHub Actions can merge it with the matching **`[0.3.0]`** section from `docs/CHANGELOG.md` when publishing the release.
