...
**Tag message:** keep the first line short (e.g. `0.3.1: fix Twig Web UI loader path (REQ-TWIG-001)`); GitHub Actions can merge it with the matching **`[0.3.1]`** section from `docs/CHANGELOG.md` when publishing the release.
