...
**Tag message:** keep the first line short (e.g. `1.1.0: missing-log Web UI role gate`); GitHub Actions can merge it with the matching changelog section when publishing the release.
